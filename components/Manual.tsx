    ...
    <div className="max-w-[1600px] mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-10 duration-1000 pb-40 px-6">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-end gap-12">
           <div className="space-y-6">
              ...
              <p className="text-slate-500 text-xl font-medium italic max-w-2xl border-l-4 border-indigo-500/30 pl-6">
                Standard Operativo di Precisione per l'organizzazione {commandName}.
              </p>
           </div>
      ...
      {activeTab === 'genesis' ? (
            ...
            <div className="lg:col-span-8 space-y-16">
              <div className="space-y-8">
                <h2 className="text-6xl font-black text-slate-900 italic tracking-tighter uppercase leading-none">
                  ...
                  <span className="text-indigo-600 underline decoration-indigo-100 underline-offset-[12px]">Precisione Operativa</span>
                </h2>
                ...
                <div className="relative p-12 bg-white rounded-[3.5rem] border border-slate-100 shadow-xl overflow-hidden group">
                  ...
                  <div className="relative z-10 prose prose-slate prose-2xl italic text-slate-600 font-medium leading-[1.6] space-y-10 text-justify">
                    <p>
                      "Il Vault nasce dall'esigenza viscerale di colmare un vuoto nella gestione della memoria amministrativa. Non bastava digitalizzare; serviva un'entità che garantisse la **Sovranità del Dato** per ogni organizzazione professionale."
                    </p>
                    <p>
                      "Abbiamo costruito un baluardo dove l'errore umano viene eroso dall'algoritmo e dove ogni risorsa trova la sua collocazione logica in un sistema di verità assoluta, adattabile a qualsiasi comando militare o ufficio governativo."
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-indigo-600 rounded-[3.5rem] p-12 text-white shadow-2xl relative overflow-hidden">
                ...
                <ul className="space-y-10">
                  {[
                    ...
                    { t: "Evoluzione", d: "Protocolli adattivi basati sui feedback continui." }
                  ].map((p, i) => (
        ...
        <div className="animate-in fade-in zoom-in-95 duration-700 px-4 min-h-[1000px] flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-96 flex flex-col gap-2 overflow-y-auto no-scrollbar pr-4">
            <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] mb-4 pl-4 border-l-2 border-indigo-500/20">Sezioni Operative</h4>
            {chapters.map((ch) => (
              <button
                key={ch.id}
      ...
      <div className="pt-32 border-t border-slate-200 flex flex-col items-center gap-8 text-center">
         ...
         <div className="space-y-4">
            <p className="text-lg font-black text-slate-400 uppercase tracking-[0.4em] italic">Vault Master Protocol - Versione Universale</p>
            <div className="space-y-1">
               <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">SISTEMA DI PROPRIETÀ: {commandName.toUpperCase()}</p>
